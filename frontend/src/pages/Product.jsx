...
import { convertImage } from "../helpers/functions";
import toast from "react-hot-toast";
import { Footer, Navbar } from "../components";
import { getProductById, getProductsByCategories } from '../apis/product'
  ...
  useEffect(() => {
    const getProduct = async () => {
      try {
        ...
        if (categories) {
          const similarProducts = await getProductsByCategories(categories);
